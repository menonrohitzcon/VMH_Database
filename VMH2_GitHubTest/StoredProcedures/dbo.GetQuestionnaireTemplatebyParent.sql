...
GO
ALTER TABLE [dbo].[Questionnaires]  WITH NOCHECK ADD  CONSTRAINT [FK_Questionnaires_Clients] FOREIGN KEY([ClientId])
REFERENCES [dbo].[Clients] ([ClientId])
GO
ALTER TABLE [dbo].[Questionnaires] NOCHECK CONSTRAINT [FK_Questionnaires_Clients]
GO
ALTER TABLE [dbo].[Questionnaires]  WITH NOCHECK ADD  CONSTRAINT [FK_Questionnaires_QuestionnaireTemplates] FOREIGN KEY([QuestionnaireTemplateId])
REFERENCES [dbo].[QuestionnaireTemplates] ([QuestionnaireTemplateId])
GO
ALTER TABLE [dbo].[Questionnaires] NOCHECK CONSTRAINT [FK_Questionnaires_QuestionnaireTemplates]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
EXEC [GetQuestionnaireTemplatebyParent]
      @ClientId ='2FA3C1FD-ADE8-4CBE-8F10-DC745F8CB806',    
		 ...
		 @ParentId ='6207CC9B-7C81-4C48-B2D5-78F56D2AE896',
		 @RelatedParentId ='1350B665-C42D-4408-8DA7-4B710ECB4DA3'
*/
CREATE PROCEDURE [dbo].[GetQuestionnaireTemplatebyParent]
	(
		 ...
		 @RelatedParentId uniqueidentifier
...
BEGIN
	  ...
	  Questionnaires.QuestionnaireTemplateId,
	  QuestionnaireTemplates.TemplateName

	  From Questionnaires
	  inner join QuestionnaireTemplates
	  ON Questionnaires.QuestionnaireTemplateId=QuestionnaireTemplates.QuestionnaireTemplateId
	  Where Questionnaires.ParentId=@ParentId
	    and Questionnaires.RelatedParentId=@RelatedParentId
