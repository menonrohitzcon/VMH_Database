...
CREATE TABLE [dbo].[DocumentTemplate](
	...
	[TemplateName] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[OwnerUserId] [uniqueidentifier] NULL,
	[FileName] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ViewName] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[IsActive] [bit] NULL,
	[IsMultipleView] [bit] NULL,
	[Description] [nvarchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedBy] [uniqueidentifier] NULL,
	[CreatedDateTime] [datetime] NULL,
	[UpdatedBy] [uniqueidentifier] NULL,
...
CREATE TABLE [dbo].[ApplicationDocuments](
	...
	[ProductServiceSubtypeId] [uniqueidentifier] NOT NULL,
	[SequenceNo] [int] NULL,
	[DocumentName] [nvarchar](500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[UpdatedBy] [uniqueidentifier] NULL,
	[UpdatedDateTime] [datetime] NULL,
 CONSTRAINT [PK_ApplicationDocuments] PRIMARY KEY CLUSTERED 
(
...
GO
ALTER TABLE [dbo].[DocumentTemplate]  WITH NOCHECK ADD  CONSTRAINT [FK_DocumentTemplate_Divisions] FOREIGN KEY([DivisionId])
REFERENCES [dbo].[Divisions] ([DivisionId])
GO
ALTER TABLE [dbo].[DocumentTemplate] NOCHECK CONSTRAINT [FK_DocumentTemplate_Divisions]
GO
ALTER TABLE [dbo].[DocumentTemplate]  WITH NOCHECK ADD  CONSTRAINT [FK_DocumentTemplate_Users] FOREIGN KEY([OwnerUserId])
REFERENCES [dbo].[Users] ([UserId])
GO
ALTER TABLE [dbo].[DocumentTemplate] NOCHECK CONSTRAINT [FK_DocumentTemplate_Users]
GO
ALTER TABLE [dbo].[ApplicationDocuments]  WITH CHECK ADD  CONSTRAINT [FK_ApplicationDocuments_DocumentTemplate] FOREIGN KEY([DocumentTemplateId])
REFERENCES [dbo].[DocumentTemplate] ([DocumentTemplateId])
GO
ALTER TABLE [dbo].[ApplicationDocuments] CHECK CONSTRAINT [FK_ApplicationDocuments_DocumentTemplate]
GO
ALTER TABLE [dbo].[ApplicationDocuments]  WITH CHECK ADD  CONSTRAINT [FK_ApplicationDocuments_ProductServiceSubtypes] FOREIGN KEY([ProductServiceSubtypeId])
REFERENCES [dbo].[ProductServiceSubtypes] ([ProductServiceSubtypeId])
GO
ALTER TABLE [dbo].[ApplicationDocuments] CHECK CONSTRAINT [FK_ApplicationDocuments_ProductServiceSubtypes]
GO
